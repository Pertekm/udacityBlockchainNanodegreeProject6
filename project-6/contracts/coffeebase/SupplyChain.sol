...
contract SupplyChain is Ownable, DistributorRole, ConsumerRole, RetailerRole, FarmerRole {
    ...
    constructor() public payable {
        // Call constructor of super class (Ownable)?
        sku = 1;
        upc = 1;
    }
    ...
    function harvestItem(
        ...
        onlyFarmer()
     {
        ...
        Item memory newItem = Item(
            sku, // generated
            _upc,
            _originFarmerID, // owner (msg.sender?)
            _originFarmerID,
            _originFarmName,
    ...
    // Define a function 'fetchItemBufferOne' that fetches the data (excluding state, includes origin farmer)
    ...
    // Define a function 'fetchItemBufferTwo' that fetches the data (include state, excluding farmer)
